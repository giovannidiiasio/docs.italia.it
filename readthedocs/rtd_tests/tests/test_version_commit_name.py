...
class VersionCommitNameTests(TestCase):
    ...
    def test_branch_name_made_friendly_when_sha(self):
        ...
        version = new(Version, identifier=commit_hash,
                      slug=settings.STABLE, verbose_name=settings.STABLE, type=TAG)
    ...
    def test_branch_with_name_stable(self):
        version = new(Version, identifier=u'origin/stable', slug=settings.STABLE,
    ...
    def test_hg_latest_branch(self):
        ...
        version = new(Version, identifier=u'default', slug=settings.LATEST,
                      verbose_name=settings.LATEST, type=BRANCH, project=hg_project)
    ...
    def test_git_latest_branch(self):
        ...
        version = new(Version, project=git_project,
                      identifier=u'origin/master', slug=settings.LATEST,
                      verbose_name=settings.LATEST, type=BRANCH)
